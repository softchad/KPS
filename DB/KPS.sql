...
CREATE TABLE `home` (
  ...
  `name_home` varchar(255) DEFAULT NULL,
...
INSERT INTO `home` VALUES (5,'Namas1',45);
...
INSERT INTO `occupant` VALUES (5,44),(5,47);
...
INSERT INTO `price` VALUES (5,1,30),(5,3,10);
...
INSERT INTO `service` VALUES (1,'Dujos'),(2,'Vanduo'),(3,'Elektra');
...
INSERT INTO `user` VALUES (1,'admin','admin','admin'),(44,'Vienas','vienas','occupant'),(45,'Du','du','manager'),(47,'Vytas','Petronis','occupant'),(49,'Vadas','vadas','manager');
...
-- Dump completed on 2024-12-14 19:31:14
